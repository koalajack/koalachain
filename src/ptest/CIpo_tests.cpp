...
//const int64_t totalSendMoney = 10825192381120926;
//const int64_t totalSendMoney =  2711374031363492;
//const int64_t totalSendMoney =  2677621584404177;
//const int64_t totalSendMoney = 19164400000000000;
//const int64_t totalSendMoney =    4913960000000000;
//const int64_t totalSendMoney =    17567366666666608;
//const int64_t totalSendMoney =    20000000000000000;
const int64_t totalSendMoney = 16696666666666610;
IPO_DATA arrayData[]=
{
...
bool CIpoTest::SendIpoTx(unsigned char type)
{
	...
	{
		string des = strprintf("%s", userarray[i].address);
		int64_t nMoney = userarray[i].money;
		Object obj;
