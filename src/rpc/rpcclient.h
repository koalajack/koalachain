...
// Copyright (c) 2009-2013 The KOALA developers
// Copyright (c) 2016 The Koala developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef _KOALARPC_CLIENT_H_
#define _KOALARPC_CLIENT_H_ 1
...
/** Show help message for KOALA-cli.
 ...
 *
 * @note the argument can be removed once koala-cli functionality is removed from koalad
 */
