...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  //  ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "getkoalastate",          &getkoalastate,          false,      false,      false }, //true
	...
	{ "walletlockv2",           &walletlockv2,           true,      false,      true },
	{ "walletpassphrasechange", &walletpassphrasechange, false,     false,      true },
	{ "walletpassphrase",       &walletpassphrase,       true,      false,      true },
	{ "walletpassphrasev2",     &walletpassphrasev2,     true,      false,      true },
	...
	{ "getscriptvalidedata",    &getscriptvalidedata,    true,      false,      true },
	{ "signmessage",            &signmessage,            false,     false,      true },
	{ "sendtoaddress",          &sendtoaddress,          false,     false,      true },
	{ "sendtoaddressv2",        &sendtoaddressv2,        false,     false,      true },
	{ "sendtoaddresswithfee",   &sendtoaddresswithfee,   false,     false,      true },
    { "getbalance",             &getbalance,             false,     false,      true },
    { "getbalancev2",           &getbalancev2,           false,     false,      true },
         ...
         (SysCfg().GetArg("-rpcuser", "") == SysCfg().GetArg("-rpcpassword", ""))) && SysCfg().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("%s, you must set a rpcpassword in the configuration file:\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"Koala Alert\" admin@foo.com\n"),
                strWhatAmI,
...
void RPCRunLater(const string& name, boost::function<void(void)> func, int64_t nSeconds)
{
    ...
    if (deadlineTimers.count(name) == 0)
    {
        deadlineTimers.insert(make_pair(name,
                                        std::shared_ptr<deadline_timer>(new deadline_timer(*rpc_io_service))));
    }
