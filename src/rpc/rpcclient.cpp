...
Array RPCConvertValues(const string &strMethod, const vector<string> &strParams)
{
    ...
    if (strMethod == "listtransactionsv2"       && n > 1) ConvertTo<int64_t>(params[1]);
    if (strMethod == "listtransactionsv2"       && n > 2) ConvertTo<int64_t>(params[2]);
    ...
    if (strMethod == "getkoalastate"          && n > 0) ConvertTo<int>(params[0]);
 ...
 //   if (strMethod == "registaccounttx"          && n > 2) ConvertTo<bool>(params[2]);
    ...
    if (strMethod == "getscriptvalidedata" && n>1) ConvertTo<int>(params[1]);
    if (strMethod == "getscriptvalidedata" && n>2) ConvertTo<int>(params[2]);
...
string HelpMessageCli(bool mainProgram)
{
    ...
    if(mainProgram)
    {
        ...
        strUsage += "\n" + _("SSL options: (see the Koala Wiki for SSL setup instructions)") + "\n";
