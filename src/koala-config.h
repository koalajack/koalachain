/* src/koala-config.h.  Generated from koala-config.h.in by configure.  */
/* src/koala-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KOALA_CONFIG_H

#define KOALA_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@koala.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Koala Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Koala Core 1.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "koala"
