...
#ifndef KOALA_CHAIN_PARAMS_H
#define KOALA_CHAIN_PARAMS_H
#include <memory>
#include "bignum.h"
#include "uint256.h"
 ...
 * Koala system. There are three: the main network on which people trade goods
