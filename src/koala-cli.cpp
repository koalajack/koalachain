...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || SysCfg().IsArgCount("-?") || SysCfg().IsArgCount("--help"))
    {
        // First part of help message is specific to RPC client
            _("Usage:") + "\n" +
              "  koala-cli [options] <command> [params]  " + _("Send command to koala Core") + "\n" +
              "  koala-cli [options] help                " + _("List commands") + "\n" +
              "  koala-cli [options] help <command>      " + _("Get help for a command") + "\n";
