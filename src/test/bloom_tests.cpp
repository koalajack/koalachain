...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
	...
	CDataStream stream(ParseHex("020000004d0449f6a390f734568e3ad4bead7b4abd8cdfe48839\
...
c38bd52715bd94bc7505c28ffdb4b0d0"), SER_NETWORK, PROTOCOL_VERSION);
	...
	filter.insert(uint256S("0xb09135750f39e4ccb81c39ace2820f8eabecf0ee8e4138427091130ffe45c13c"));
	...
	BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0xb09135750f39e4ccb81c39ace2820f8eabecf0ee8e4138427091130ffe45c13c"));
	...
	filter.insert(uint256S("0x9eeed094d4dc4327ae5af54ba92b991ae545840d2fa882eb90c0f62d0885f5b9"));
	...
	BOOST_CHECK(merkleBlock.vMatchedTxn[1].second == uint256S("0x9eeed094d4dc4327ae5af54ba92b991ae545840d2fa882eb90c0f62d0885f5b9"));
...
c38bd52715bd94bc7505c28ffdb4b0d0"), SER_NETWORK, PROTOCOL_VERSION);
	...
	filter.insert(uint256S("0xed525c5920c8f353a1d6a080f5f6e1c3bb12fa5100efe8cce44ed6f04682b61b"));
	...
	BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0xed525c5920c8f353a1d6a080f5f6e1c3bb12fa5100efe8cce44ed6f04682b61b"));
...
BOOST_AUTO_TEST_CASE(merkle_block_3_and_serialize)
{
	...
	// With one tx
	CBlock block;
	CDataStream stream(ParseHex("0200000060203f9559534438ca3e15b94a9b0d304d3b62ad264a\
...
dbea9300876c"), SER_NETWORK, PROTOCOL_VERSION);//CDataStream stream(ParseHex(""), SER_NETWORK, PROTOCOL_VERSION);
	...
	filter.insert(uint256S("0x3c342dc28981ce6e41a247cc0a4f3d8ceeac5854f518dfc3eca43d11e4705f17"));
	...
	BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x3c342dc28981ce6e41a247cc0a4f3d8ceeac5854f518dfc3eca43d11e4705f17"));
	BOOST_CHECK(merkleBlock.vMatchedTxn[0].first == 0);
...
BOOST_AUTO_TEST_CASE(merkle_block_4)
{
	...
	BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256S("0x9eeed094d4dc4327ae5af54ba92b991ae545840d2fa882eb90c0f62d0885f5b9"));
